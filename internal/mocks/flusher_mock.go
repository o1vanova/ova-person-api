...
// Source: github.com/ozonva/ova-person-api/internal/flusher (interfaces: Flusher)
...
func (m *MockFlusher) Flush(arg0 context.Context, arg1 []person.Person) []person.Person {
	m.ctrl.T.Helper()
